...
public class StringsBenchMarkTimeElapsed {
	   public static void main(String[] args) {
		   
		   	  long mainBeginTime, mainEndTime;
		   	  mainBeginTime = System.nanoTime();
		      ...
		      mainEndTime = System.nanoTime();
		      double totalTimeByMain = ((mainEndTime - mainBeginTime) * Math.pow(10, -9));
		      System.out.println("Total time taken by your main program is: "+ totalTimeByMain+" secs");
		   }
}
